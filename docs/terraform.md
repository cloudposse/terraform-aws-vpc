...
| <a name="input_classiclink_enabled"></a> [classiclink\_enabled](#input\_classiclink\_enabled) | Whether to enable/disable ClassicLink for the VPC | `bool` | `false` | no |
...
| <a name="input_default_route_table_deny_all"></a> [default\_route\_table\_deny\_all](#input\_default\_route\_table\_deny\_all) | When `true`, manage the default route table and remove all routes, disabling all ingress and egress.<br>When `false`, do not mange the default route table, allowing it to be managed by another component. | `bool` | `false` | no |
...
| <a name="input_dns_hostnames_enabled"></a> [dns\_hostnames\_enabled](#input\_dns\_hostnames\_enabled) | Whether to enable/disable DNS hostnames in the VPC | `bool` | `true` | no |
| <a name="input_dns_support_enabled"></a> [dns\_support\_enabled](#input\_dns\_support\_enabled) | Whether to enable/disable DNS support in the VPC | `bool` | `true` | no |
...
| <a name="input_internet_gateway_enabled"></a> [internet\_gateway\_enabled](#input\_internet\_gateway\_enabled) | Whether to enable/disable Internet Gateway creation | `bool` | `true` | no |
...
| <a name="input_ipv6_egress_only_internet_gateway_enabled"></a> [ipv6\_egress\_only\_internet\_gateway\_enabled](#input\_ipv6\_egress\_only\_internet\_gateway\_enabled) | Whether to enable/disable IPv6 Egress-Only Internet Gateway creation | `bool` | `false` | no |
