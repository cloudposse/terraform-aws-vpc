...
| <a name="input_cidr_block"></a> [cidr\_block](#input\_cidr\_block) | IPv4 CIDR to assign to the VPC! This parameter is ignored if ipam\_pool\_id is passed | `string` | `""` | no |
...
| <a name="input_ipam_pool_id"></a> [ipam\_pool\_id](#input\_ipam\_pool\_id) | n/a | `string` | `"Id of the IPAM pool to obtain ip from"` | no |
